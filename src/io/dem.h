...
constexpr size_t DEM_BASE_DETECTOR_ID_COORD_IDX{0};
constexpr size_t DEM_ROUND_ID_COORD_IDX{1};
constexpr size_t DEM_COLOR_COORD_IDX{2};
constexpr size_t DEM_FLAG_COORD_IDX{3}; 
